...
<div class="col-md-7 col-lg-5 col-xl-5 offset-xl-1 ">
    ...
    <form>
        ...
        <!-- Select de Rol -->
        <div data-mdb-input-init class="form-outline mb-4">
            <select class="form-select form-control-lg" id="form1Example13" aria-label="Default select example" required>
                <option disabled selected>Selecciona un Rol</option>
                <option value="#">Propietario</option>
                <option value="#">Arrendatario</option>
            </select>
            <label class="form-label text" for="form1Example13">Rol</label>
        </div>
        ...
        <div class="d-flex justify-content-around align-items-center mb-4">
            ...
            <a href="./login.php" style="color:rgb(50, 125, 238);">¿Tienes cuenta? Inicia Sección</a>
        </div>
